...
| Network     | Network partition within cluster, or between cluster and users                    |
| Application | Crashes in Kubernetes software                                                    |
| Data        | Data loss or unavailability of persistent storage (e.g. GCE PD or AWS EBS volume) |
| Human Error | Operator error, e.g. misconfigured Kubernetes software or application software    |
